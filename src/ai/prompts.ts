...
- body ОБОВ'ЯЗКОВО з 3 абзаців через \\n\\n (не 1 і не 2). Разом 550–780 символів чистого тексту.
  1) Що сталося: факти, цифри, місце, хто постраждав / що змінилось
  2) Чому це важливо для українців у CH / як впливає на життя
  3) Що зробити практично: кроки, на що звернути увагу, де перевірити
...
- 3–6 виділень на пост. Не розмічай цілі абзаци.
- Тон: живий, дружній, без канцеляриту. 1–2 емодзі в body максимум.
- takeaway: практичний інсайт 50–120 символів, без 💡 і лапок
- cta: обов'язковий заклик до дії 40–100 символів (окреме поле, не частина body)
...
- title
- body: РІВНО 3 абзаци через \\n\\n, разом 550–780 символів
- takeaway
- cta
- imagePrompt
...
2) РІВНО 3 інформативні абзаци з конкретикою (що сталося / чому важливо / що зробити); використовуй <b>, <i>, <u> для ключових фактів (помірно)
